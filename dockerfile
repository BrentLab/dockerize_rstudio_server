...
RUN Rscript -e "install.packages(c('rmarkdown', 'tidyverse', 'workflowr','BiocManager', 'usethis', 'ggplot2','RSQLite', 'readxl', 'here', 'vroom', 'caret', 'broom', 'ggsci', 'DT', 'TidyMultiqc'), Ncpus=10);"
